      ...
      <div className="px-20 py-12">
        <div className="grid grid-cols-12 space-x-9 ">
          ...
          <div className="col-span-6 relative">
            <div className="absolute  -right-7 top-[8%] bg-red-500 w-14 h-14 rounded-full "></div>
            <img src={teampic} alt="" className="h-[80vh] w-full rounded-3xl" />
            <div className="absolute bottom-7 -left-7 bg-blue-950 w-14 h-14 rounded-full "></div>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center gap-4 py-12">
          ...
          <div className="border-b-4 text-[#0A6EB7] h-3 w-[15%]"></div>
          <img src={teamAll} alt="" />
        </div>
      </div>
    </>
