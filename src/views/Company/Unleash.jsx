    ...
    <div className="bg-primary pb-14 pt-4">
      <div className="flex flex-col items-center gap-7 py-[10px] px-[20px] text-center text-white ">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-5 py-2.5 font-semibold text-md md:text-lg lg:text-xl rounded-md bg-white text-primary hover:scale-110 duration-300 transition-all"
        >
